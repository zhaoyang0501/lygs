          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="index.html">首页</a><i class="fa fa-angle-double-right"></i>酒店预订
              </div>
            </div>
          </div>
        </div>
 ...
 <section class="envor-section">
        <div class="container">
          <div class="row" style="margin-top: 0px;">
            <div class="col-lg-12">
              <p class="block-description">旅游网会员服务</p>
              <p>加入会员，您还享受专属1对1服务，更有优先安排、更换线路、福利赠送等各种特权。</p>
              <div class="envor-sorting" id="portfolio-sorting">
                ...
                ><a  href=hotel>全部</a> </span>
                 <c:forEach items="${cagegorys }" var="bean">
                   <span data-value="html" id='span_${bean.id }'><a  href="hotel?cid=${bean.id }">${bean.name }</a> </span>
                 </c:forEach>
                </div>
                <!--
                ...
                <div class="row" style="margin-top: 60px;">
                  ...
                  <div class="envor-projects-listing envor-projects-listing-5-cols" style="margin-left: -30px; width: 1170px;">
					...
					<c:forEach items="${hotels }" var="bean">
						<article class="envor-project envor-padding-bottom-30 envor-padding-left-30 javascript html envor-sorting-item envor-listing-item" style="width: 234px;">
		                      <div class="envor-project-inner">
		                        <figure><a href=""><img src="http://pic4.40017.cn/zzy/rpimage/2016/10/11/22/gEV4dO.jpg" alt=""></a><figcaption style="display: none;"><a href="http://pic4.40017.cn/zzy/rpimage/2016/10/11/22/gEV4dO.jpg" title="Morbi sagittis lacinia" class="colorbox cboxElement"><i class="fa fa-plus" style="top: 0px;"></i></a></figcaption></figure>
		                        <div class="envor-project-details">
		                         <p class="link"><a href="viewphotel?id=${bean.id }">【西安】${bean.name }</a></p>
		                          <p class="filter" ><h3 style="color: red">${bean.price }元	起</h3></p>
		                        </div>
		                      </div>
                   		 </article>
					</c:forEach>
