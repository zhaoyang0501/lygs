          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="index.html">首页</a><i class="fa fa-angle-double-right"></i>热门景点预订
              </div>
            </div>
          </div>
        </div>
					...
					<c:forEach items="${projects }" var="bean">
						<article class="envor-project envor-padding-bottom-30 envor-padding-left-30 javascript html envor-sorting-item envor-listing-item" style="width: 234px;">
		                      <div class="envor-project-inner">
		                        <figure><a href=""><img src="//pic4.40017.cn/gny/line/2017/02/10/08/eq6WOy_260x200_00.jpg" alt=""></a><figcaption style="display: none;"><a href="//pic4.40017.cn/gny/line/2017/02/10/08/eq6WOy_260x200_00.jpg" title="Morbi sagittis lacinia" class="colorbox cboxElement"><i class="fa fa-plus" style="top: 0px;"></i></a></figcaption></figure>
		                        <div class="envor-project-details">
		                         <p class="link"><a href="viewproject?id=${bean.id }">【西安】${bean.name }</a></p>
