          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="index.html">首页</a><i class="fa fa-angle-double-right"></i>门票预订
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="row envor-margin-top-0" style="margin-top: 60px;">
                ...
                <div class="col-lg-3">
                  <div id="envor-project-images" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="item">
                        <a href="//pic4.40017.cn/gny/line/2017/02/10/08/eq6WOy_260x200_00.jpg" class="colorbox cboxElement"><img src="//pic4.40017.cn/gny/line/2017/02/10/08/eq6WOy_260x200_00.jpg" alt=""></a>
                ...
                <div class="col-lg-9">
                 ...
                 <p><label for="rt1-fax">预约日期</label><input type="text"  id='orderDate' name='orderDate'></p>
                  ...
                  <p><label for="rt1-fax">地址</label><input type="text"  name='addr'></p>
