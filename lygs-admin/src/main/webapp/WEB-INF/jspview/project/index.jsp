...
<body >
                            ...
                            <div class="col-sm-12 b-r">
		                           ...
		                           <input name='id' type="hidden"/>
		                           	<table class='table table-bordered'>
		                           		<thead>
		                           		<tr style="text-align: center;" ><td colspan="6" ><h3>添加景点<h3></h3></td></tr>
		                           		</thead>
		                           		<tbody>
		                           			<tr>
		                           				<td>分类</td>
   ...
   <script>
    ...
    function submit_form(){
    	$.ajax({
    		   type: "POST",
    		   url:  $.common.getContextPath() + "/project/save",
    		   data: $("form").serialize(),
    ...
    function fun_delete(id){
    	layer.confirm('确定删除当前景点？', {
    		  btn: ['确定','取消'] //按钮
    		}, function(){
    			$.ajax({
    		 		   url:  $.common.getContextPath() + "/project/delete?id="+id,
    		 		   success: function(msg){
    		 		     if(msg.code==1){
    		 		    	 toastr.success('操作成功');
    		 		    	 table.draw();
    ...
    $(document).ready(function(){
        	...
        	table=$('#dt_table_view').DataTable( {
	            ...
	            "ajax": {
	                "url":  $.common.getContextPath() + "/project/list",
	                "type": "POST",
	                "dataSrc": "datas"
	              },
				"columns" : [{
