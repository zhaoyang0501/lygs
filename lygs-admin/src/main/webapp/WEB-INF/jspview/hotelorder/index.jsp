                    ...
                    <div class="ibox-content">
                        <form role="form" class="form-inline">
                            <div class="form-group">
                                <label for="exampleInputEmail2" class="sr-only">酒店名称</label>
   ...
   <script>
    ...
    function fun_approve(id){
    	layer.confirm('确定审核通过？', {
    		  btn: ['确定','取消'] //按钮
    			...
    			$.ajax({
    		 		   url:  $.common.getContextPath() + "/hotelorder/approve?id="+id,
    		 		   success: function(msg){
    		 		     if(msg.code==1){
    		 		    	 toastr.success('操作成功');
    		 		    	 table.draw();
    ...
    $(document).ready(function(){
        	...
        	table=$('#dt_table_view').DataTable( {
	            ...
	            "ajax": {
	                "url":  $.common.getContextPath() + "/hotelorder/list",
	                "type": "POST",
	                "dataSrc": "datas"
	              },
				"columns" : [{
				 ...
				 "columnDefs": [
				              
				                {
				                    "render": function ( data, type, row ) {
				                   	 return "<a tager='_blank' href='javascript:void(0)' onclick='fun_approve("+data+")'>审核通过 </a>"
				                    },
				                    "targets":8
				                },
				                {
